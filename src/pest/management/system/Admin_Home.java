...
public class Admin_Home extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        productTable.setFont(new java.awt.Font("Dialog", 1, 12)); // NOI18N
        ...
        jMenuItem4.setText("ADD SOIL TEST LABS");
...
//                tbData[1]=  { id, product, pest, crop, trap,duration,cost,per_acre};
    ...
    private void jMenuItem3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem3ActionPerformed
           ...
           /* Connection con=CommonDb.getConnection();
            try{
                PreparedStatement pr= con.prepareStatement("Select * from order_details ");
...
System.out.println(ex);
    ...
    private void jMenuItem4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem4ActionPerformed
      new SoilCenters().setVisible(true);        // TODO add your handling code here:
